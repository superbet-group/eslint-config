module.exports = {
  plugins: ["react", "react-prefer-function-component", "@superbet/react"],
  ...
  rules: {
    ...
    "react/boolean-prop-naming": [
      "error",
      {
        ...
        message:
          'Boolean prop "{{ propName }}" should be prefixed with "is", "was", "has", or "had"',
      },
    ],
    ...
    // This rule replaces the above one, is it provides a way to customise default export behaviour
    ...
    // TODO: check if this rule plays well with TypeScript
