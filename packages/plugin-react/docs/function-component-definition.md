...
description: Custom rule to better enforce React function component definition.
tags:
  - eslint
  - programming
  - best practices
...
# Enforce a Specific Function Type for Function Components (`@superbet/eslint-plugin-react/function-component-definition`)

> This rule adds additional functionality on top of `react/function-component-definition`.
